...
import static org.junit.jupiter.api.Assertions.assertEquals;
    ...
    public class BookingRepositoryTest {
        ...
        public void testFindByBookedIdAndItemId() {
            List<Booking> bookingsForUser1AndItem = bookingRepository.findBookingByBookerIdAndItemId(user1.getId(), item.getId());
            assertEquals(3, bookingsForUser1AndItem.size());

            List<Booking> bookingsForUser2AndItem = bookingRepository.findBookingByBookerIdAndItemId(user2.getId(), item.getId());
